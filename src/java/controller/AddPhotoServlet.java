    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(request.getParameter("photoname")==null){
            ...
            if(session.getAttribute("username")!=null){
                ...
                String path = "";
                switch(catid){
                    case 0: out = new FileOutputStream(new File("C:\\Users\\Michel\\Documents\\GitHub\\Artkodes\\web\\assets\\photos\\deception\\deception("+photoNo+").jpg"));
                            filecontent = filePart.getInputStream();
                            data = new byte[filecontent.available()];
                            out.write(data, 0, data.length);
                            path = "./assets/photos/deception/deception("+photoNo+").jpg";
                            break;
                    case 1: out = new FileOutputStream(new File("C:\\Users\\Michel\\Documents\\GitHub\\Artkodes\\web\\assets\\photos\\musee\\musee("+photoNo+").jpg"));
                            filecontent = filePart.getInputStream();
                            data = new byte[filecontent.available()];
                            out.write(data, 0, data.length);
                            path = "./assets/photos/musee/musee("+photoNo+").jpg";
                            break;
                    case 2: out = new FileOutputStream(new File("C:\\Users\\Michel\\Documents\\GitHub\\Artkodes\\web\\assets\\photos\\pfw\\pfw("+photoNo+").jpg"));
                            filecontent = filePart.getInputStream();
                            data = new byte[filecontent.available()];
                            out.write(data, 0, data.length);
                            path = "./assets/photos/pfw/pfw("+photoNo+").jpg";
                            break;
                    case 3: out = new FileOutputStream(new File("C:\\Users\\Michel\\Documents\\GitHub\\Artkodes\\web\\assets\\photos\\rebel\\rebel("+photoNo+").jpg"));
                            filecontent = filePart.getInputStream();
                            data = new byte[filecontent.available()];
                            out.write(data, 0, data.length);
                            path = "./assets/photos/rebel/rebel("+photoNo+").jpg";
                            break;
                    case 4: out = new FileOutputStream(new File("C:\\Users\\Michel\\Documents\\GitHub\\Artkodes\\web\\assets\\photos\\the-prince\\tp("+photoNo+").jpg"));
                            filecontent = filePart.getInputStream();
                            data = new byte[filecontent.available()];
                            out.write(data, 0, data.length);
                            path = "./assets/photos/the-prince/tp("+photoNo+").jpg";
                            break;
                    case 5: out = new FileOutputStream(new File("C:\\Users\\Michel\\Documents\\GitHub\\Artkodes\\web\\assets\\photos\\tired-boys\\tb("+photoNo+").jpg"));
                            filecontent = filePart.getInputStream();
                            data = new byte[filecontent.available()];
                            out.write(data, 0, data.length);
